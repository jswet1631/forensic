...
Canada, reported at https://www.blood.ca/en/blood/donating-blood/whats-my-blood-type)
...
**Answer:** <hide>$\mbox{P(A and }-) = \frac{60}{1000} = 0.06$.<hide>

**2.** What is the probability that the person selected has ABO group AB?

**Answer:** <hide>$\mbox{P(AB)} = \frac{25 + 5}{1000} = \frac{30}{1000} = 0.03$.<hide>

**3.** What is the probability that the person selected is male and has type A blood and type O blood?
