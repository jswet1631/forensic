...
Suppose that we have a population of 1000 people, each classified
...
instance, there are a total of $16 + 24 = 40$ people with blood type AB, so

$$
\mbox{P(Type AB)} = \frac{40}{1000} = 0.04
$$

For another example, there are a total of $235 + 24 + 63 + 248 = 570$ males in 
our population, so
