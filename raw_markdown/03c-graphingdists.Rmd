...
We begin with an example from the previous section on the weights of 371 bags 
containing a substance suspected of being narcotics.  The weights of the bags 
range from 215 to 270 grams.  Below are the weights for 10 bags. (It is not
practical to show them all.)

$$
240.91, 234.66, 246.84, 244.24, 253.39, 245.07, 228.75, 237.29, 255.69, 254.64
$$
To construct the bot plot, we start by finding the 25th, 50th, and 75th percentiles
in the distribution of our data.  Recall that the 25th percentile is the quantity such
that 25% of the data values are less than this quantity, and similarly for the
other percentiles.  Figure \@ref(fig:boxplot) shows how these three percentiles 
are incorporated into a box plot, with the limits of the box extending from the 
25th to 75 percentile and a line in between at the 50th percentile.
